...
import org.syncon.evernote.utils.Convert64BitNumberToNumber;
  ...
  public class Note  implements TBase   {
    ...
    private static const CREATED_FIELD_DESC:TField = new TField("created", TType.DOUBLE, 6);
    private static const UPDATED_FIELD_DESC:TField = new TField("updated", TType.DOUBLE, 7);
    private static const DELETED_FIELD_DESC:TField = new TField("deleted", TType.DOUBLE, 8);
    ...
    public function set deleted(deleted:Number):void {
      ...
      while (true)
      {
        ...
        switch (field.id)
        {
          ...
          case RESOURCES:
            if (field.type == TType.LIST) {
              {
                var _list119:TList = iprot.readListBegin();
                this.resources = new Array();
                for (var _i120:int = 0; _i120 < _list119.size; ++_i120)
                {
                  var _elem121:Resource;
                  _elem121 = new Resource();
                  _elem121.read(iprot);
                  this.resources.push(_elem121);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case TAGNAMES:
            if (field.type == TType.LIST) {
              {
                var _list122:TList = iprot.readListBegin();
                this.tagNames = new Array();
                for (var _i123:int = 0; _i123 < _list122.size; ++_i123)
                {
                  var _elem124:String;
                  _elem124 = iprot.readString();
                  this.tagNames.push(_elem124);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.tagGuids != null) {
        oprot.writeFieldBegin(TAG_GUIDS_FIELD_DESC);
        {
          ...
          for each (var elem125:* in this.tagGuids)          {
      ...
      if (this.resources != null) {
        oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
        {
          ...
          for each (var elem126:* in this.resources)          {
            elem126.write(oprot);
          }
          oprot.writeListEnd();
        }
      ...
      if (this.tagNames != null) {
        oprot.writeFieldBegin(TAG_NAMES_FIELD_DESC);
        {
          ...
          for each (var elem127:* in this.tagNames)          {
