...
import org.apache.thrift.protocol.*;
  ...
  public class UserAttributes implements TBase   {
    ...
    private static const DATE_AGREED_TO_TERMS_OF_SERVICE_FIELD_DESC:TField = new TField("dateAgreedToTermsOfService", TType.DOUBLE, 11);
    ...
    private static const SENT_EMAIL_DATE_FIELD_DESC:TField = new TField("sentEmailDate", TType.DOUBLE, 15);
    ...
    private static const EMAIL_OPT_OUT_DATE_FIELD_DESC:TField = new TField("emailOptOutDate", TType.DOUBLE, 18);
    private static const PARTNER_EMAIL_OPT_IN_DATE_FIELD_DESC:TField = new TField("partnerEmailOptInDate", TType.DOUBLE, 19);
    ...
    private static const CUSTOMER_PROFILE_ID_FIELD_DESC:TField = new TField("customerProfileId", TType.DOUBLE, 27);
    ...
    private var _dateAgreedToTermsOfService:Number;
    ...
    private var _sentEmailDate:Number;
    ...
    private var _emailOptOutDate:Number;
    public static const EMAILOPTOUTDATE:int = 18;
    private var _partnerEmailOptInDate:Number;
    ...
    private var _customerProfileId:Number;
    ...
    public function get dateAgreedToTermsOfService():Number {
      return this._dateAgreedToTermsOfService;
    }

    public function set dateAgreedToTermsOfService(dateAgreedToTermsOfService:Number):void {
    ...
    public function get sentEmailDate():Number {
      return this._sentEmailDate;
    }

    public function set sentEmailDate(sentEmailDate:Number):void {
    ...
    public function get emailOptOutDate():Number {
      return this._emailOptOutDate;
    }

    public function set emailOptOutDate(emailOptOutDate:Number):void {
    ...
    public function get partnerEmailOptInDate():Number {
      return this._partnerEmailOptInDate;
    }

    public function set partnerEmailOptInDate(partnerEmailOptInDate:Number):void {
    ...
    public function get customerProfileId():Number {
      return this._customerProfileId;
    }

    public function set customerProfileId(customerProfileId:Number):void {
    ...
    public function read(iprot:TProtocol):void {
      ...
      while (true)
      {
        ...
        switch (field.id)
        {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i30:int = 0; _i30 < _list29.size; ++_i30)
                {
                  ...
                  this.viewedPromotions.push(_elem31);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.LIST) {
              {
                ...
                for (var _i33:int = 0; _i33 < _list32.size; ++_i33)
                {
                  ...
                  this.recentMailedAddresses.push(_elem34);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case DATEAGREEDTOTERMSOFSERVICE:
            if (field.type == TType.DOUBLE) {
              this.dateAgreedToTermsOfService = iprot.readDouble();
              this.__isset_dateAgreedToTermsOfService = true;
            } else { 
              TProtocolUtil.skip(iprot, field.type);
            }
          ...
          case SENTEMAILDATE:
            if (field.type == TType.DOUBLE) {
              this.sentEmailDate = iprot.readDouble();
              this.__isset_sentEmailDate = true;
            } else { 
              TProtocolUtil.skip(iprot, field.type);
            }
          ...
          case EMAILOPTOUTDATE:
            if (field.type == TType.DOUBLE) {
              this.emailOptOutDate = iprot.readDouble();
              this.__isset_emailOptOutDate = true;
            } else { 
              TProtocolUtil.skip(iprot, field.type);
            }
          ...
          case PARTNEREMAILOPTINDATE:
            if (field.type == TType.DOUBLE) {
              this.partnerEmailOptInDate = iprot.readDouble();
              this.__isset_partnerEmailOptInDate = true;
            } else { 
              TProtocolUtil.skip(iprot, field.type);
            }
          ...
          case CUSTOMERPROFILEID:
            if (field.type == TType.DOUBLE) {
              this.customerProfileId = iprot.readDouble();
              this.__isset_customerProfileId = true;
            } else { 
              TProtocolUtil.skip(iprot, field.type);
            }
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.viewedPromotions != null) {
        oprot.writeFieldBegin(VIEWED_PROMOTIONS_FIELD_DESC);
        {
          ...
          for each (var elem35:* in this.viewedPromotions)          {
      ...
      if (this.recentMailedAddresses != null) {
        oprot.writeFieldBegin(RECENT_MAILED_ADDRESSES_FIELD_DESC);
        {
          ...
          for each (var elem36:* in this.recentMailedAddresses)          {
      ...
      oprot.writeDouble(this.dateAgreedToTermsOfService);
      oprot.writeFieldEnd();
      ...
      oprot.writeDouble(this.sentEmailDate);
      oprot.writeFieldEnd();
      ...
      oprot.writeDouble(this.emailOptOutDate);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(PARTNER_EMAIL_OPT_IN_DATE_FIELD_DESC);
      oprot.writeDouble(this.partnerEmailOptInDate);
      oprot.writeFieldEnd();
      ...
      oprot.writeDouble(this.customerProfileId);
      oprot.writeFieldEnd();
