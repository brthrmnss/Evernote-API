...
import org.apache.thrift.protocol.*;
  ...
  public class NoteAttributes implements TBase   {
    ...
    private static const SUBJECT_DATE_FIELD_DESC:TField = new TField("subjectDate", TType.DOUBLE, 1);
    ...
    private var _subjectDate:Number;
    ...
    public function get subjectDate():Number {
      return this._subjectDate;
    }

    public function set subjectDate(subjectDate:Number):void {
        ...
        switch (field.id)
        {
          case SUBJECTDATE:
            if (field.type == TType.DOUBLE) {
              this.subjectDate = iprot.readDouble();
              this.__isset_subjectDate = true;
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      oprot.writeDouble(this.subjectDate);
      oprot.writeFieldEnd();
