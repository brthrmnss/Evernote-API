  ...
  public class NoteStoreProcessor implements TProcessor {
    ...
    private function getSyncState():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        } catch (EDAMUserException userException) {
          result.userException = userException;
        } catch (EDAMSystemException systemException) {
          result.systemException = systemException;
        } catch (Throwable th) {
          LOGGER.error("Internal error processing getSyncState", th);
    ...
    private function getSyncChunk():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getSyncChunk", th);
    ...
    private function listNotebooks():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listNotebooks", th);
    ...
    private function getNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          result.systemException = systemException;
        } catch (EDAMNotFoundException notFoundException) {
          result.notFoundException = notFoundException;
        } catch (Throwable th) {
          LOGGER.error("Internal error processing getNotebook", th);
    ...
    private function getDefaultNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getDefaultNotebook", th);
    ...
    private function createNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createNotebook", th);
    ...
    private function updateNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateNotebook", th);
    ...
    private function expungeNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeNotebook", th);
    ...
    private function listTags():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listTags", th);
    ...
    private function listTagsByNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listTagsByNotebook", th);
    ...
    private function getTag():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getTag", th);
    ...
    private function createTag():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createTag", th);
    ...
    private function updateTag():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateTag", th);
    ...
    private function untagAll():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing untagAll", th);
    ...
    private function expungeTag():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeTag", th);
    ...
    private function listSearches():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listSearches", th);
    ...
    private function getSearch():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getSearch", th);
    ...
    private function createSearch():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createSearch", th);
    ...
    private function updateSearch():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateSearch", th);
    ...
    private function expungeSearch():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeSearch", th);
    ...
    private function findNotes():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing findNotes", th);
    ...
    private function findNoteCounts():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing findNoteCounts", th);
    ...
    private function getNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getNote", th);
    ...
    private function getNoteContent():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getNoteContent", th);
    ...
    private function getNoteSearchText():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getNoteSearchText", th);
    ...
    private function getNoteTagNames():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getNoteTagNames", th);
    ...
    private function createNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createNote", th);
    ...
    private function updateNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateNote", th);
    ...
    private function deleteNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing deleteNote", th);
    ...
    private function expungeNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeNote", th);
    ...
    private function expungeNotes():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeNotes", th);
    ...
    private function expungeInactiveNotes():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeInactiveNotes", th);
    ...
    private function copyNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing copyNote", th);
    ...
    private function listNoteVersions():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listNoteVersions", th);
    ...
    private function getNoteVersion():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getNoteVersion", th);
    ...
    private function getResource():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResource", th);
    ...
    private function updateResource():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateResource", th);
    ...
    private function getResourceData():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResourceData", th);
    ...
    private function getResourceByHash():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResourceByHash", th);
    ...
    private function getResourceRecognition():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResourceRecognition", th);
    ...
    private function getResourceAlternateData():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResourceAlternateData", th);
    ...
    private function getResourceAttributes():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getResourceAttributes", th);
    ...
    private function getAccountSize():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getAccountSize", th);
    ...
    private function getAds():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getAds", th);
    ...
    private function getRandomAd():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getRandomAd", th);
    ...
    private function getPublicNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getPublicNotebook", th);
    ...
    private function createSharedNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createSharedNotebook", th);
    ...
    private function listSharedNotebooks():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listSharedNotebooks", th);
    ...
    private function expungeSharedNotebooks():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeSharedNotebooks", th);
    ...
    private function createLinkedNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing createLinkedNotebook", th);
    ...
    private function updateLinkedNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing updateLinkedNotebook", th);
    ...
    private function listLinkedNotebooks():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing listLinkedNotebooks", th);
    ...
    private function expungeLinkedNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing expungeLinkedNotebook", th);
    ...
    private function authenticateToSharedNotebook():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing authenticateToSharedNotebook", th);
    ...
    private function getSharedNotebookByAuth():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing getSharedNotebookByAuth", th);
    ...
    private function emailNote():Function {
      return function(seqid:int, iprot:TProtocol, oprot:TProtocol):void
      {
        ...
        try {
          ...
          LOGGER.error("Internal error processing emailNote", th);
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list524:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i525:int = 0; _i525 < _list524.size; ++_i525)
              {
                var _elem526:Notebook;
                _elem526 = new Notebook();
                _elem526.read(iprot);
                this.success.push(_elem526);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
      {
        ...
        for each (var elem527:* in this.success)        {
          elem527.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class listTags_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list559:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i560:int = 0; _i560 < _list559.size; ++_i560)
              {
                var _elem561:Tag;
                _elem561 = new Tag();
                _elem561.read(iprot);
                this.success.push(_elem561);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem562:* in this.success)        {
          elem562.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class listTagsByNotebook_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list569:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i570:int = 0; _i570 < _list569.size; ++_i570)
              {
                var _elem571:Tag;
                _elem571 = new Tag();
                _elem571.read(iprot);
                this.success.push(_elem571);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem572:* in this.success)        {
          elem572.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class listSearches_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list606:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i607:int = 0; _i607 < _list606.size; ++_i607)
              {
                var _elem608:SavedSearch;
                _elem608 = new SavedSearch();
                _elem608.read(iprot);
                this.success.push(_elem608);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem609:* in this.success)        {
          elem609.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list676:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i677:int = 0; _i677 < _list676.size; ++_i677)
              {
                var _elem678:String;
                _elem678 = iprot.readString();
                this.success.push(_elem678);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
      {
        ...
        for each (var elem679:* in this.success)        {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        ...
        case NOTEGUIDS:
          if (field.type == TType.LIST) {
            {
              var _list706:TList = iprot.readListBegin();
              this.noteGuids = new Array();
              for (var _i707:int = 0; _i707 < _list706.size; ++_i707)
              {
                var _elem708:String;
                _elem708 = iprot.readString();
                this.noteGuids.push(_elem708);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.noteGuids != null) {
      oprot.writeFieldBegin(NOTE_GUIDS_FIELD_DESC);
      {
        ...
        for each (var elem709:* in this.noteGuids)        {
...
class listNoteVersions_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list731:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i732:int = 0; _i732 < _list731.size; ++_i732)
              {
                var _elem733:NoteVersionId;
                _elem733 = new NoteVersionId();
                _elem733.read(iprot);
                this.success.push(_elem733);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem734:* in this.success)        {
          elem734.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class getResourceData_result implements TBase {
  ...
  public function get success():byte[] {
    return this._success;
  }

  public function set success(success:byte[]):void {
    this._success = success;
  }
...
class getResourceByHash_args implements TBase {
  ...
  public function get contentHash():byte[] {
    return this._contentHash;
  }

  public function set contentHash(contentHash:byte[]):void {
...
class getAds_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list804:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i805:int = 0; _i805 < _list804.size; ++_i805)
              {
                var _elem806:Ad;
                _elem806 = new Ad();
                _elem806.read(iprot);
                this.success.push(_elem806);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem807:* in this.success)        {
          elem807.write(oprot);
        }
        oprot.writeListEnd();
      }
...
class listSharedNotebooks_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list829:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i830:int = 0; _i830 < _list829.size; ++_i830)
              {
                var _elem831:SharedNotebook;
                _elem831 = new SharedNotebook();
                _elem831.read(iprot);
                this.success.push(_elem831);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem832:* in this.success)        {
          elem832.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        ...
        case SHAREDNOTEBOOKIDS:
          if (field.type == TType.LIST) {
            {
              var _list835:TList = iprot.readListBegin();
              this.sharedNotebookIds = new Array();
              for (var _i836:int = 0; _i836 < _list835.size; ++_i836)
              {
                var _elem837:Number;
                _elem837 = iprot.readDouble();
                this.sharedNotebookIds.push(_elem837);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.sharedNotebookIds != null) {
      oprot.writeFieldBegin(SHARED_NOTEBOOK_IDS_FIELD_DESC);
      {
        ...
        for each (var elem838:* in this.sharedNotebookIds)        {
          oprot.writeDouble(elem838);
        }
        oprot.writeListEnd();
      }
      oprot.writeFieldEnd();
...
class listLinkedNotebooks_result implements TBase {
    ...
    while (true)
    {
      ...
      switch (field.id)
      {
        case SUCCESS:
          if (field.type == TType.LIST) {
            {
              var _list860:TList = iprot.readListBegin();
              this.success = new Array();
              for (var _i861:int = 0; _i861 < _list860.size; ++_i861)
              {
                var _elem862:LinkedNotebook;
                _elem862 = new LinkedNotebook();
                _elem862.read(iprot);
                this.success.push(_elem862);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public function write(oprot:TProtocol):void {
    ...
    if (this.isSetSuccess()) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRUCT, this.success.length));
        for each (var elem863:* in this.success)        {
          elem863.write(oprot);
        }
        oprot.writeListEnd();
      }
