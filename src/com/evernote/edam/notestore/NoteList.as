        ...
        switch (field.id)
        {
          ...
          case NOTES:
            if (field.type == TType.LIST) {
              {
                var _list68:TList = iprot.readListBegin();
                this.notes = new Array();
                for (var _i69:int = 0; _i69 < _list68.size; ++_i69)
                {
                  var _elem70:Note;
                  _elem70 = new Note();
                  _elem70.read(iprot);
                  this.notes.push(_elem70);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case STOPPEDWORDS:
            if (field.type == TType.LIST) {
              {
                var _list71:TList = iprot.readListBegin();
                this.stoppedWords = new Array();
                for (var _i72:int = 0; _i72 < _list71.size; ++_i72)
                {
                  var _elem73:String;
                  _elem73 = iprot.readString();
                  this.stoppedWords.push(_elem73);
                }
                iprot.readListEnd();
              }
            } else { 
          ...
          case SEARCHEDWORDS:
            if (field.type == TType.LIST) {
              {
                var _list74:TList = iprot.readListBegin();
                this.searchedWords = new Array();
                for (var _i75:int = 0; _i75 < _list74.size; ++_i75)
                {
                  var _elem76:String;
                  _elem76 = iprot.readString();
                  this.searchedWords.push(_elem76);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.notes != null) {
        oprot.writeFieldBegin(NOTES_FIELD_DESC);
        {
          ...
          for each (var elem77:* in this.notes)          {
            elem77.write(oprot);
          }
          oprot.writeListEnd();
        }
      ...
      if (this.stoppedWords != null) {
        oprot.writeFieldBegin(STOPPED_WORDS_FIELD_DESC);
        {
          ...
          for each (var elem78:* in this.stoppedWords)          {
      ...
      if (this.searchedWords != null) {
        oprot.writeFieldBegin(SEARCHED_WORDS_FIELD_DESC);
        {
          ...
          for each (var elem79:* in this.searchedWords)          {
