        ...
        switch (field.id)
        {
          case NOTEBOOKCOUNTS:
            if (field.type == TType.MAP) {
              {
                var _map83:TMap = iprot.readMapBegin();
                this.notebookCounts = new Dictionary();
                for (var _i84:int = 0; _i84 < _map83.size; ++_i84)
                {
                  var _key85:String;
                  var _val86:int;
                  _key85 = iprot.readString();
                  _val86 = iprot.readI32();
                  this.notebookCounts[_key85] = _val86;
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.notebookCounts != null) {
        oprot.writeFieldBegin(NOTEBOOK_COUNTS_FIELD_DESC);
        {
          ...
          for (var _key91:* in this.notebookCounts) {
            _sizeCounter92++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.I32, _sizeCounter92));
          for (var elem93:* in this.notebookCounts)          {
            oprot.writeString(elem93);
            oprot.writeI32(this.notebookCounts[elem93]);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (this.tagCounts != null) {
        ...
        {
          var _sizeCounter95:int = 0;
          for (var _key94:* in this.tagCounts) {
            _sizeCounter95++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.I32, _sizeCounter95));
          for (var elem96:* in this.tagCounts)          {
            oprot.writeString(elem96);
            oprot.writeI32(this.tagCounts[elem96]);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
