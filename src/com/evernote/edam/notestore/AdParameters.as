        ...
        switch (field.id)
        {
          ...
          case IMPRESSIONS:
            if (field.type == TType.LIST) {
              {
                var _list104:TList = iprot.readListBegin();
                this.impressions = new Array();
                for (var _i105:int = 0; _i105 < _list104.size; ++_i105)
                {
                  var _elem106:AdImpressions;
                  _elem106 = new AdImpressions();
                  _elem106.read(iprot);
                  this.impressions.push(_elem106);
                }
                iprot.readListEnd();
              }
            } else { 
            ...
            if (field.type == TType.MAP) {
              {
                ...
                for (var _i108:int = 0; _i108 < _map107.size; ++_i108)
                {
                  ...
                  this.clientProperties[_key109] = _val110;
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.impressions != null) {
        oprot.writeFieldBegin(IMPRESSIONS_FIELD_DESC);
        {
          ...
          for each (var elem111:* in this.impressions)          {
            elem111.write(oprot);
          }
          oprot.writeListEnd();
        }
      ...
      if (this.clientProperties != null) {
        oprot.writeFieldBegin(CLIENT_PROPERTIES_FIELD_DESC);
        {
          ...
          for (var _key112:* in this.clientProperties) {
            _sizeCounter113++;
          }
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, _sizeCounter113));
          for (var elem114:* in this.clientProperties)          {
            oprot.writeString(elem114);
            oprot.writeString(this.clientProperties[elem114]);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
